...
/**
 * SubTrustAExecutionService
 * Members Asset Pool Unit Trust Deed — Sub-Trust A
 * Electronic Transactions Act 1999 (Cth) + s.14G ETA 2000 (NSW)
 */
class SubTrustAExecutionService
{
    public const DEED_KEY       = 'sub_trust_a';
    public const DEED_TITLE     = 'COGS OF AUSTRALIA FOUNDATION MEMBERS ASSET POOL UNIT TRUST DEED';
    public const DEED_VERSION   = 'Sub-Trust A';
    public const DEED_PDF       = 'COGS_SubTrustA.pdf';
    public const DEED_SHA256    = '2c4157a9483bbf9f5368b3b8ae074f8e61f6383e830637ca6645e089cfe7cddf';
    ...
    public const DECLARANT_ACKNOWLEDGEMENT =
        "I, Thomas Boyd Cunliffe, execute this Deed as Declarant of Sub-Trust A. "
    ...
    public const TRUSTEE_ACKNOWLEDGEMENT =
        "I, Thomas Boyd Cunliffe, execute this Deed as Caretaker Trustee of Sub-Trust A of the "
        . "COGS of Australia Foundation Community Joint Venture Mainspring Hybrid Trust. "
        . "I accept the office of Caretaker Trustee of Sub-Trust A and undertake to hold and administer "
    ...
    public const WITNESS_ATTESTATION_TEXT =
        ...
        . "execute the COGS of Australia Foundation Members Asset Pool Unit Trust Deed (Sub-Trust A) "
    ...
    public static function recordWitnessAttestation(PDO $db, string $sessionId, string $ipAddress, string $userAgent): array
    {
        ...
        try {
            ...
            $eveId=(int)$db->lastInsertId();
            $db->prepare('INSERT INTO evidence_vault_entries (entry_type,subject_type,subject_id,subject_ref,payload_hash,payload_summary,source_system,chain_tx_hash,created_by_type,created_at) VALUES (\'witness_attestation\',\'deed\',0,?,?,?,\'witness_attestation\',?,\'system\',?)')->execute([$attId,$recHash,sprintf('Witness attestation — Sub-Trust A — witness: %s',self::WITNESS_NAME),'0x'.$recHash,$nowDb]);
    ...
    {
        $allowed=['sub_trust_a_execution','sub_trust_a_witness'];
