...
/**
 * SubTrustCExecutionService
 * Members Asset Pool Unit Trust Deed — Sub-Trust A
 * Electronic Transactions Act 1999 (Cth) + s.14G ETA 2000 (NSW)
 */
class SubTrustCExecutionService
{
    public const DEED_KEY       = 'sub_trust_c';
    public const DEED_TITLE     = 'COGS OF AUSTRALIA FOUNDATION DISCRETIONARY CHARITABLE TRUST DEED';
    public const DEED_VERSION   = 'Sub-Trust C';
    public const DEED_PDF       = 'COGS_SubTrustC.pdf';
    public const DEED_SHA256    = '63eb7ef704001a8819a178b857efc3ef15f04e1a41e7fda7007392373672fdfa';
    ...
    public const DECLARANT_ACKNOWLEDGEMENT =
        "I, Thomas Boyd Cunliffe, execute this Deed as Declarant of Sub-Trust C. "
    ...
    public const TRUSTEE_ACKNOWLEDGEMENT =
        "I, Thomas Boyd Cunliffe, execute this Deed as Caretaker Trustee of Sub-Trust C of the "
        . "COGS of Australia Foundation Community Joint Venture Mainspring Hybrid Trust. "
        . "I accept the office of Caretaker Trustee of Sub-Trust C and undertake to hold and administer "
    ...
    public const WITNESS_ATTESTATION_TEXT =
        ...
        . "execute the COGS of Australia Foundation Discretionary Charitable Trust Deed (Sub-Trust C) "
    ...
    public static function recordWitnessAttestation(PDO $db, string $sessionId, string $ipAddress, string $userAgent): array
    {
        ...
        try {
            ...
            $eveId=(int)$db->lastInsertId();
            $db->prepare('INSERT INTO evidence_vault_entries (entry_type,subject_type,subject_id,subject_ref,payload_hash,payload_summary,source_system,chain_tx_hash,created_by_type,created_at) VALUES (\'witness_attestation\',\'deed\',0,?,?,?,\'witness_attestation\',?,\'system\',?)')->execute([$attId,$recHash,sprintf('Witness attestation — Sub-Trust C — witness: %s',self::WITNESS_NAME),'0x'.$recHash,$nowDb]);
    ...
    {
        $allowed=['sub_trust_c_execution','sub_trust_c_witness'];
