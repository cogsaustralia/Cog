...
function applications_determine_class(PDO $pdo, string $applicationType): ?array
{
    return match ($applicationType) {
        ...
        'pay_it_forward' => applications_fetch_token_class($pdo, ['PAY_IT_FORWARD_COG', 'PAY_IT_FORWARD', 'PAYITFORWARD']),
        default => null,
    };
}
...
{
    return match ($applicationType) {
        'personal', 'kids_snft', 'business', 'donation', 'pay_it_forward' => 'pending',
