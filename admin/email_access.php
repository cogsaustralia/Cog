...
<div class="card summary-box"><div class="heading-line"><strong>What this page does</strong></div><p class="muted" style="margin:10px 0 0">Email Access is the queue-backed outbound email operations page. Use it to send a test email, process the queue, resend outstanding access emails, or send the thank-you and admin notice bundle for a specific member record.</p><ul class="muted" style="margin:12px 0 0 18px;line-height:1.6"><li>Use this page for delivery operations, not template editing.</li><li>Use Messages &gt; Email Templates when you need to change email content.</li><li>Use the recent queue table to confirm whether an email was sent, failed, or is still pending.</li></ul></div>
<div class="card summary-box"><div class="heading-line"><strong>Typical workflow</strong></div><div class="subgrid" style="margin-top:10px"><div><strong>1. Check content and recipient</strong><div class="muted small">Confirm the correct template exists and the recipient email is present before sending.</div></div><div><strong>2. Choose the right action</strong><div class="muted small">Use test email for SMTP checks, resend-all for outstanding access records, or member-specific actions for one record only.</div></div><div><strong>3. Process and verify</strong><div class="muted small">After sending, check Latest queue result and Recent queue for status, attempts, and any error detail.</div></div><div><strong>4. Escalate content issues separately</strong><div class="muted small">If wording is wrong, fix the template in Communications rather than repeatedly resending from this page.</div></div></div></div>
<div class="card summary-box"><div class="heading-line"><strong>How to read this page</strong></div><div class="subgrid" style="margin-top:10px"><div><strong>Actions</strong><div class="muted small">The live operational tools for queue processing and resend actions.</div></div><div><strong>Outstanding members</strong><div class="muted small">Records that still have no last access email timestamp and may need sending or cleanup.</div></div><div><strong>Latest queue result</strong><div class="muted small">The most recent queue-backed action you performed on this page.</div></div><div><strong>Recent queue</strong><div class="muted small">A delivery trace table showing recipient, template, attempts, status, and any last error.</div></div></div></div>
