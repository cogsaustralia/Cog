...
<div class="stat-grid">
  <?php foreach ($stats as $label => $value): ?>
    <div class="card stats-card"><span><?= ops_h($label) ?></span><strong><?= (int)$value ?></strong></div>
  <?php endforeach; ?>
</div>
...
<div class="row-grid">
  <div class="card">
    <h3 class="section-title">Governance control status<?= ops_admin_help_button('Governance control status', 'Each row represents a governance control area. Check evidence counts and exception counts first. A high exception count means governance may be operationally complete on paper but still missing part of its evidence trail.') ?></h3>
  ...
  <div class="card">
    <h3 class="section-title">Partners Polls<?= ops_admin_help_button('Partners Polls', 'These are the formal governance instruments. When someone asks what the partnership has voted on, this is the section to use first. Focus on title, eligibility scope, status, and voting close time.') ?></h3>
...
<div class="row-grid">
  <div class="card">
    <h3 class="section-title">Proposal register<?= ops_admin_help_button('Proposal register', 'This is the initiation and tracking layer for governance matters. Use it to see whether a topic has been opened, what type of proposal it is, and whether it has already been linked to a formal poll.') ?></h3>
  ...
  <div class="card">
    <h3 class="section-title">Governance directions<?= ops_admin_help_button('Governance directions', 'Directions are the operational instructions that follow a governance outcome. Use this section after reviewing polls to see whether action has been created, what subject it targets, and whether the direction is still pending or already executed.') ?></h3>
...
<div class="row-grid">
  <div class="card">
    <h3 class="section-title">Board execution records<?= ops_admin_help_button('Board execution records', 'These records show how a governance direction was actually carried out by the board or operator layer. Use them to verify that a direction progressed from instruction to action.') ?></h3>
  ...
  <div class="card">
    <h3 class="section-title">Proxy vote instructions<?= ops_admin_help_button('Proxy vote instructions', 'These are stewardship instructions for CHESS-held portfolio positions. Use this section when a governance outcome affects proxy voting or ESG direction at a portfolio company AGM/EGM.') ?></h3>
...
<div class="card">
  <h3 class="section-title">Vote snapshots<?= ops_admin_help_button('Vote snapshots', 'Vote snapshots are the certifiable result records that lock who could vote and what the final recorded outcome was at the relevant time. Use them for evidence, audits, disputes, and legal traceability.') ?></h3>
