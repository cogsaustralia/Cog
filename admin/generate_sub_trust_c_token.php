...
<div class="main">
  ...
  <div class="card">
    ...
    <?php if ($rawToken): ?>
      ...
      <div class="url-box">URL: <?= gdt_h($host) ?>/trustee/sub_trust_c_declare.php?token=<?= gdt_h($rawToken) ?></div>
    <?php endif; ?>
  </div>
  ...
  <div class="card" style="<?= $bothDone ? '' : 'opacity:.45;pointer-events:none' ?>">
    ...
    <?php if ($rawWitnessToken && $sessionId): ?>
      ...
      <div class="url-box">URL: <?= gdt_h($host) ?>/trustee/sub_trust_c_witness.php?token=<?= gdt_h($rawWitnessToken) ?>&session=<?= gdt_h($sessionId) ?></div>
    <?php endif; ?>
  </div>
