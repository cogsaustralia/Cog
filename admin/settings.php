...
<?= ops_admin_collapsible_help('Page guide & workflow', [
  ...
  ops_admin_workflow_panel('Typical workflow', 'Settings changes should be deliberate and traceable.', [
  ...
  ops_admin_status_panel('How to read this page', 'The setting groups below are organized by operational purpose.', [
...
<form method="post" class="group-stack">
  ...
  <?php foreach ($groups as $groupLabel => $fields): ?>
    <div class="card">
      <div class="card-head"><h2><?= ops_h($groupLabel) ?></h2></div>
      <div class="card-body">
        <div class="form-grid">
          <?php foreach ($fields as $key => $label): ?>
            <div class="field">
              <label for="<?= ops_h($key) ?>"><?= ops_h($label) ?></label>
